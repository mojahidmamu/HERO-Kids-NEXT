...
const Products = () => {
  ...
  // ✅ Wishlist হুক সঠিকভাবে ব্যবহার করো
      ...
      <AnimatePresence>
        ...
        >
          {filteredProducts.map((product, index) => {
            // ✅ প্রতিটি প্রোডাক্টের জন্য উইশলিস্ট স্টেট চেক করো
            ...
            return (
              ...
              >
                ...
                <div
                  className={`relative ${
                    viewMode === "list" ? "w-48 shrink-0" : "w-full"
                  }`}
                >
                  <div
                    className={`relative overflow-hidden ${
                      viewMode === "list" ? "rounded-xl" : "rounded-t-2xl"
                    }`}
                  >
                    <Image
                      src={product.image}
                    ...
                    {/* ✅ Wishlist Button (প্রতিটি প্রোডাক্টের জন্য আলাদা) */}
                    <button
                ...
                >
                  ...
                  {viewMode === "grid" && <CardButton product={product} />}
                </div>
              </motion.div>
            );
          })}
